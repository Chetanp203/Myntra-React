...
const Register = () => {
  ...
  return (
    <div style={{width:'100%',backgroundColor:'rgb(253,239,234)',height:'650px',padding:'30px'}}>
        <div style={{width:'450px',margin:'auto',backgroundColor:'white'}}>
            ...
            <label>Name:</label><br />
            <input type="text" onChange={handleChange} name='name' placeholder='Username'style={{width:'80%'}} /><br />
